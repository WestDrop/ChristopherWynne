 ...
 * stars geometry 
 */
 const sphere = new THREE.SphereGeometry(0.01,30,30);
...
for ( var z= 0; z < 200; z+=1 ) {
    ...
    var randomColor;
    if(randomSelector==0) {
        var randomColor = new THREE.MeshBasicMaterial({color: 0x0000FF});
    }
    if(randomSelector==1){
        var randomColor = new THREE.MeshBasicMaterial({color: 0x00FFFF});
    }
    if(randomSelector==2) {
        var randomColor = new THREE.MeshBasicMaterial({color: 0xFF0000});
    }
